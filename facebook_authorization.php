...
//edit with your info
$app_id = "1431243007123971"; //given when you created app
$app_secret = "f791295f6a8d6e3ec3d3d19d9a5d2b1e"; //given when you created app
$site_url = "http://www.ebayst.com/facebook_authorization.php"; //full path to location of this file.

// Uncomment next two lines for error reporting
...
if (!isset($_GET["code"])){
header("location: https://graph.facebook.com/oauth/authorize?client_id=".$app_id."&redirect_uri=".$site_url."&scope=".$perms);
}
else if(!isset($_GET["access_token"])){
$code = $_GET["code"];
$url = "https://graph.facebook.com/oauth/access_token?client_id=".$app_id."&redirect_uri=".$site_url."&client_secret=".$app_secret ."&code=".$code;
...
printf('<pre>Status: %s</pre><br />', var_export($response, true));
}
...
echo "<pre>";
print_r($accounts);
printf('<pre>%s</pre><br /><br />', var_export($accounts, true));
?>