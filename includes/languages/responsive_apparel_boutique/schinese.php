...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', '版权所有 &copy; ' . date('Y') . ' <a href="/" target="_blank">' . STORE_NAME . '</a> <a href="/">充气娃娃</a>');
...
//search php define
  ...
  define('HEADER_SEARCH_DEFAULT_TEXT' , '搜索“充气娃娃”试试');
  define('BOX_HEADING_SEARCH', '搜索');
...
// constants for use in zen_prev_next_display function
  ...
  define('WARNING_INSTALL_DIRECTORY_EXISTS', '安全警告: 安装目录已存在: %s，为了安全请删除该目录。');
...
// product_listing
  ...
  define('ERROR_MAXIMUM_QTY','添加到购物车的商品数量已调整，因为超过最多购买数量，见商品:<br /> ');
  define('ERROR_CORRECTIONS_HEADING','请在下面修改: <br />');
  define('ERROR_QUANTITY_ADJUSTED', '添加到购物车的商品数量已调整，您需要的商品不零卖，商品数量: <br />');
...
// shopping cart errors
  define('ERROR_PRODUCT','<br />商品：');
  define('ERROR_PRODUCT_STATUS_SHOPPING_CART','<br />很抱歉该商品已经不在数据库中。<br />该商品已经从购物车中删除。');
  define('ERROR_PRODUCT_ATTRIBUTES','<br />商品: ');
  define('ERROR_PRODUCT_STATUS_SHOPPING_CART_ATTRIBUTES','<br />很抱歉，该商品选项已变化，不在库存中。<br />本件商品已从购物车中删除。');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('MODULE_TABS_NEW','最新商品');
  define('MODULE_TABS_SPECIALS','特价商品');
  define('MODULE_TABS_FEATURED','热销商品');
