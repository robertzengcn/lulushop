...
define('ICON_IMAGE_TINYCART', 'cart.png');

//alt tags for buttons
define('ICON_ERROR_ALT', '错误');
define('ICON_SUCCESS_ALT', '成功');
define('ICON_WARNING_ALT', '警告');
define('ICON_TRASH_ALT', '点击此处删除该商品.');
define('ICON_UPDATE_ALT', '修改购物车中的商品数量');
define('ICON_TINYCART_ALT', '点击此处添加商品到你的购物车');
