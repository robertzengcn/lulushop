...
// page title
define('TITLE', '艾美嘉情趣用品!');

// Site Tagline
define('SITE_TAGLINE', '最具诚信的情趣用品网站,【全场正品】专营各类实体娃娃，充气仿真娃娃，硅胶娃娃等保健情趣用品。保密快递，全场低价，免运费');

// Custom Keywords
define('CUSTOM_KEYWORDS', '硅胶娃娃，实体娃娃，仿真娃娃');
