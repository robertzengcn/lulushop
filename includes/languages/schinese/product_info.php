...
//reviews
define('TEXT_CURRENT_REVIEWS_RATING', '评论得分: ');
define('SUB_TITLE_RATING', '为商品评级，5星最高: ');
define('SUB_TITLE_REVIEW', '提交评论：');
define('TEXT_REVIEW_NAME', '姓名：');
define('TEXT_NO_HTML', '备注：请不要使用HTML代码');
define('TEXT_APPROVAL_REQUIRED', '备注：评论将在审核通过后显示');
