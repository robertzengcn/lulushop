...
define('BUTTON_LOG_OFF_ALT', '退出');
define('BUTTON_ADD_TO_CART_ALT', '添加到购物车');
define('BUTTON_ADD_ADDRESS_ALT', '添加地址');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','添加所选商品到购物车');
define('BUTTON_BACK_ALT', '返回');
define('BUTTON_BUY_NOW_ALT', '购买');
define('BUTTON_CANCEL_ALT', '取消');
define('BUTTON_CHANGE_ADDRESS_ALT', '修改地址');
define('BUTTON_CHECKOUT_ALT', '结算');
define('BUTTON_CONFIRM_SEND_ALT', '使用礼品卡');
...
define('BUTTON_DOWNLOAD_ALT', '现在下载');
define('BUTTON_EDIT_SMALL_ALT', '编辑');
define('BUTTON_IN_CART_ALT', '添加到购物车');
define('BUTTON_LOGIN_ALT', '登录');
define('BUTTON_NEXT_ALT', '下一个');
define('BUTTON_PREVIOUS_ALT', '上一个');
define('BUTTON_REDEEM_ALT', '赎回');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', '回到产品列表');
define('BUTTON_REVIEWS_ALT', '查看评论');
define('BUTTON_SEARCH_ALT', '搜索');
define('BUTTON_SEND_ALT', '发送');
define('BUTTON_SEND_ANOTHER_ALT', '使用另一个礼品卡');
define('BUTTON_SEND_A_GIFT_CERT_ALT', '使用礼品卡');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', '运费估算');
define('BUTTON_SOLD_OUT_ALT', '已售罄');
define('BUTTON_SOLD_OUT_SMALL_ALT', '已售罄');
define('BUTTON_SUBMIT_ALT', '提交信息');
define('BUTTON_UNSUBSCRIBE', '退定');
define('BUTTON_UPDATE_ALT', '更新');
define('BUTTON_VIEW_SMALL_ALT', '视图');
define('BUTTON_WRITE_REVIEW_ALT', '写商品评价');
define('BUTTON_READ_REVIEWS_ALT', '读商品评价');
define('BUTTON_GOTO_PROD_DETAILS_ALT', '了解商品详细信息');
define('BUTTON_MORE_REVIEWS_ALT', '更多评价');
