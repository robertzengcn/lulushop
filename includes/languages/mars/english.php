...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank"><strong>' . STORE_NAME . '</strong></a>. Powered by <strong><a href="http://loxdesign.net" target="_blank">LoxDesign</a></strong>');
...
// cart contents
  ...
  define('PRODUCTS_ORDER_QTY_TEXT','Quantity: ');
