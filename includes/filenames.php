...
define('FILENAME_ALIPAY_ORDERPROCESS', 'alipay_orderprocess');
...
define('FILENAME_ALIPAY', 'alipay');
define('FILENAME_ALIPAY_NOTIFY', 'alipay_notify');
...
define('FILENAME_ALIPAY_CHECKOUT','alipay_checkout');
