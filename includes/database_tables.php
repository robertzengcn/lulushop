...
define('TABLE_ALIPAY_RECORD', DB_PREFIX . 'alipay_record');
...
define('TABLE_CAI_KEYWORD_LIST', DB_PREFIX . 'cai_keyword_list');
define('TABLE_CAI_CATELOGUE', DB_PREFIX . 'cai_catelogue');
define('TABLE_CAI_URL', DB_PREFIX . 'cai_url');
define('TABLE_CAI_TRANSLATOR', DB_PREFIX . 'cai_translator');
define('TABLE_CAI_ARTICLE', DB_PREFIX . 'cai_article');
define('TABLE_BAIDU_TRANSTER', DB_PREFIX . 'baidu_transter');
define('TABLE_CAI_PRODUCTLINK', DB_PREFIX . 'cai_productlink');