...
if(isset($_GET['trade_status']) && $_GET['trade_status'] != null){


	
	//$orderId=zen_db_prepare_input($_GET['outTradeNo']);
	


	 
	require(DIR_WS_MODULES . zen_get_module_directory(FILENAME_ALIPAY_NOTIFY));
