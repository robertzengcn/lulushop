    ...
    <div class="container">       
      ...
      <ul class="headerInfo">
              ...
              <?php } else { if (STORE_STATUS == '0') { ?>
			          <li class="login"><a href="<?php echo zen_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL'); ?>"><?php echo HEADER_TITLE_CREATE_ACCOUNT; ?></a></li>
                  ...
                  <div>
                    <?php                    
                      if ($_SESSION['cart']->count_contents() != 0) { ?>
                        <div class="items"><strong><?php echoBOX_HEADING_SHOPPING_CART;?>:</strong> <?php echo $_SESSION['cart']->count_contents(); ?> <?php echo HEADER_CART_ITEMS; ?></div>
                    ...
                    <?php }else{ ?>
                        <div class="items empty"><strong><?php echo BOX_HEADING_SHOPPING_CART; ?></strong> <?php echo $_SESSION['cart']->count_contents(); ?> <?php echo HEADER_CART_ITEMS; ?></div>                      
                    <?php } ?>
                  </div>
