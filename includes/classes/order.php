...
/* END: ADD MY CUSTOM DETAILS */
  ...
  function get_order_stute($orderid){
  	$checkorderid=zen_db_prepare_input($orderid);
  	global $db;
  	$check_order_query = "SELECT orders_status FROM " . TABLE_ORDERS . "
                           WHERE orders_id = :orderid";
  	 
  	$check_order_query  =$db->bindVars($check_order_query, ':orderid', $checkorderid, 'integer');
  	$check_customer = $db->Execute($check_order_query);
  	return $check_customer->fields['orders_status'];
