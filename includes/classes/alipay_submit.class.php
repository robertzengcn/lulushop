...
class AlipaySubmit {
	...
	/**
	 * 在付款前做准备,把订单信息写入数据库，以防漏单
	 * @param $para_sort 已排序要签名的数组
	 * 
	 */
	
// 	function beforemakepay($customerid,$customername,$sendto,$currency,$ordertotal,$orderip){
// 		global $db;
...
// 				"customers_street_address"=>$sendaddressdetail->fields['entry_street_address'],
// 				"customers_city"=>$sendaddressdetail->fields['entry_city'],
// 				"customers_postcode"=>$sendaddressdetail->fields['entry_postcode'],
// 				"customers_country"=>$sendaddressdetail->fields['entry_country_id'],
// 				"customers_telephone"=>$sendaddressdetail->fields['entry_telephone'],
// 				"customers_address_format_id"=>1,
// 				"delivery_name"=>$customername,
// 				"delivery_street_address"=>$sendaddressdetail->fields['entry_street_address'],
// 				"delivery_city"=>$sendaddressdetail->fields['entry_city'],
// 				"delivery_postcode"=>$sendaddressdetail->fields['entry_postcode'],
// 				"delivery_country"=>$sendaddressdetail->fields['entry_city'],
...
// 				"orders_date_finished"=>NULL,
// 				"currency"=>$currency,
// 				"currency_value"=>$currencydetail->fields['value'],
// 				"order_total"=>$ordertotal,
// 				"ip_address"=>$orderip,
// 				"shipping_telephone"=>$sendaddressdetail->fields['entry_telephone']												
// 		);
// 		zen_db_perform(TABLE_ORDERS, $sql_data_array);
// 		$order_id = zen_db_insert_id();
// 		return $order_id;
// 	}
