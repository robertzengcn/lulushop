...
const CACHE_DIRECTORY = 'translate/cache/';
...
//     curl_setopt($ch, CURLOPT_HTTPHEADER, array("Authorization: Basic " . base64_encode($this->accountKey . ":" . $this->accountKey)));
...
//     $response = curl_exec($ch);
    ...
    if(!empty($response) && isset($response)){
        ...
        return array('stute'=>true,'content'=>$response);
    } else {
    	return array('stute'=>false,'content'=>self::UNEXPECTED_ERROR);
