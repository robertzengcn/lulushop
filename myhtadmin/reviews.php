...
<?php require(DIR_WS_INCLUDES . 'headerhtml.php'); ?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
         <tr><?php echo zen_draw_form('search', FILENAME_REVIEWS, '', 'get'); ?>
            <td class="pageHeading"><?php echo HEADING_TITLE; ?><div><a onclick="add_review()">(添加评论)</a></div></td>
...
function add_review(){
	...
	var d = dialog({
	    ...
	    id: 'addreviewbox',
	    width:400,	    
	    content: '<div id="addreview"><div class="addelement"><span>商品id:</span><input type=""number" id="productid" name="productid"/></div><div class="addelement"><span>客户名:</span><input type="text" id="customername" name="customername"/></div><div class="addelement"><span>评论内容:</span><textarea rows="3" cols="20"></textarea></div><div class="addelement"><span>时间:</span><input type="text" id="customername" name="customername"/></div></div>',
	    button: [
	             {
	                 value: '提交',
	                 callback: function () {
