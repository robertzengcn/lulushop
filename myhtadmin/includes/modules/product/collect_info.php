  ...
  die('Illegal Access');
    ...
    if (isset($_GET['pID']) && empty($_POST)) {
      $product = $db->Execute("select pd.products_name, pd.products_description, pd.products_url,
                                      ...
                                      p.products_price_sorter, p.master_categories_id, mtpd.metatags_title, mtpd.metatags_keywords, mtpd.metatags_description
                              from " . TABLE_PRODUCTS . " AS p LEFT JOIN " . TABLE_PRODUCTS_DESCRIPTION . " AS pd ON (p.products_id = pd.products_id) LEFT JOIN ".TABLE_META_TAGS_PRODUCTS_DESCRIPTION." AS mtpd ON (p.products_id=mtpd.products_id)
                              where p.products_id = '" . (int)$_GET['pID'] . "'and pd.language_id = '" . (int)$_SESSION['languages_id'] . "'");
          ...
          <tr>
            ...
            <td colspan="2"><table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="main" width="100%"><?php echo zen_draw_textarea_field('products_description[' . $languages[$i]['id'] . ']', 'soft', '80%', '30', htmlspecialchars((isset($products_description[$languages[$i]['id']])) ? stripslashes($products_description[$languages[$i]['id']]) : zen_get_products_description($pInfo->products_id, $languages[$i]['id']), ENT_COMPAT, CHARSET, TRUE),'id=products_description[' . $languages[$i]['id'] . ']'); //,'id="'.'products_description' . $languages[$i]['id'] . '"'); ?></td>
              </tr>
            </table></td>
          </tr>
<?php
          ...
          <tr>
            <td class="main" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <tr>
                <td class="main"><img src="/images/<?php echo $pInfo->products_image;?>" width="100px" height="100px"></td>
                </tr>
...
?>          
            <tr>
        <td class="main">SEO title</td><td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15'); ?><input type="text" value="<?php echo $pInfo->metatags_title;?>" name="metatags_title[<?php echo $languages[$i]['id'];?>]" size="60"></td>
      </tr>
            <tr>
        <td class="main">SEO keyword</td><td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15'); ?><input type="text" value="<?php echo $pInfo->metatags_keywords;?>" name="metatags_keywords[<?php echo $languages[$i]['id'];?>]" size="60"></td>
      </tr>
                  <tr>
        <td class="main">SEO description</td><td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15'); ?><input type="text" value="<?php echo $pInfo->metatags_description;?>" name="metatags_description[<?php echo $languages[$i]['id'];?>]" size="150"></td>
      </tr>
<?php
    }
?>      
