...
<script type="text/javascript" src="/myhtadmin/ckfinder/ckfinder.js"></script>
...
{
filebrowserBrowseUrl : '/myhtadmin/ckfinder/ckfinder.html',
filebrowserImageBrowseUrl : '/myhtadmin/ckfinder/ckfinder.html?Type=Images',
filebrowserFlashBrowseUrl : '/myhtadmin/ckfinder/ckfinder.html?Type=Flash',
filebrowserUploadUrl : '/myhtadmin/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
filebrowserImageUploadUrl : '/myhtadmin/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
filebrowserFlashUploadUrl : '/myhtadmin/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
});
</script>